...
dat.utils.common = function () {
    ...
    return {
        ...
        each: function (a, d, f) {
            ...
            return "[objects Function]" === Object.prototype.toString.call(a)
        }
    }
}();
...
dat.GUI = dat.gui.GUI = function (e, a, b, d, f, c, p, k, l, q, n, r, y, g, h) {
    ...
    function K(a) {
        ...
        g.bind(e, "click", function () {
            var b = prompt("Enter a new preset exName.");
            b && a.saveAs(b)
        });
    ...
    var A, H = !0, x, C = !1, I = [], m = function (a) {
        ...
        if (h.isUndefined(a.parent)) {
            ...
            g.addClass(q, "controller-exName");
            f = u(c, q);
    ...
    h.extend(m.prototype, {
        add: function (a, b) {
            ...
            if (void 0 !== this.__folders[a]) throw Error('You already have a folder in this GUI by the exName "' + a + '"');
